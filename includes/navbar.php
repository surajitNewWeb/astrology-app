...
// base folder of project (adjust if different)
$base = "/astrology-app";
?>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='horoscope.php'?'active':'')?>"
            href="<?=$base?>/public/horoscope.php">Horoscope</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='matchmaking.php'?'active':'')?>"
            href="<?=$base?>/public/matchmaking.php">Matchmaking</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='kundali.php'?'active':'')?>"
            href="<?=$base?>/public/kundali.php">Kundli</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='birthchart.php'?'active':'')?>"
            href="<?=$base?>/public/birthchart.php">Birth-Chart</a>
        </li>
      </ul>
      ...
      <div class="d-flex align-items-center auth-buttons">
        ...
        <a href="<?=$base?>/backend/user_logout.php" class="btn btn-sm btn-logout">Logout</a>
        <?php else: ?>
