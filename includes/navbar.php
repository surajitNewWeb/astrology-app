...
<nav class="navbar navbar-expand-lg astro-navbar sticky-top">
  <div class="container">
    ...
    <a class="navbar-brand fw-bold d-flex align-items-center" href="<?=$base?>/index.php">
      🌌 <span class="ms-2">AstroGuide</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="mainNavbar">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='about.php'?'active':'')?>" href="<?=$base?>/public/about.php">About</a>
        </li>
        ...
        <?php if ($logged): ?>
        <li class="nav-item">
          <a class="nav-link <?=($current_page=='dashboard.php'?'active':'')?>" href="<?=$base?>/public/dashboard.php">
            Dashboard
          </a>
        </li>
        <?php endif; ?>
